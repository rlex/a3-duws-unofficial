...
if ((_unit getVariable "callHelpDelay") > time) exitWith {["Stop screaming - you have already called for help!",0, 0.035 * safezoneH + safezoneY,5,0.3] spawn BIS_fnc_dynamicText};

_unit setVariable ["callHelpDelay", time + 3];
