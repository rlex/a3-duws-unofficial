...
if (_injuredperson distance _helper > 2.5) exitWith {[format ["%1 is too far away to press on his wounds.", name _injuredperson],0, 0.035 * safezoneH + safezoneY,5,0.3] spawn BIS_fnc_dynamicText};
