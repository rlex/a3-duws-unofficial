...
{
	idc = 1804;
	text = "NO UNLOCK SUPPORTS AT FOBs"; //--- ToDo: Localize;
	x = 26.5 * GUI_GRID_W + GUI_GRID_X;
...
class requestunitsbutton: RscButton
{
	...
	w = 11.5 * GUI_GRID_W;
	h = 1 * GUI_GRID_H;
	action = "_nil=[]ExecVM ""dialog\request_unit_fob.sqf""";
...
class requestsquadbutton: RscButton
{
	...
	w = 11.5 * GUI_GRID_W;
	h = 1 * GUI_GRID_H;
	action = "_nil=[]ExecVM ""dialog\request_squad_fob.sqf""";
...
class requestvehiclebutton: RscButton
{
	...
	action = "_nil=[]ExecVM ""dialog\request_vehicle_fob.sqf""";
};
