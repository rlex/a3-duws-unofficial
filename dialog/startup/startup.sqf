...
// ENEMY MULTIPLIER
index_enemyunit_multiplier_1 = lbAdd [2189, "*1"];
index_enemyunit_multiplier_2 = lbAdd [2189, "*2"];
index_enemyunit_multiplier_3 = lbAdd [2189, "*3"];
index_enemyunit_multiplier_4 = lbAdd [2189, "*4"];
index_enemyunit_multiplier_5 = lbAdd [2189, "*5"];

lbSetCurSel [2189, index_enemyunit_multiplier_1];

index_cp_reward_multiplier_half = lbAdd [2133, "0.5"];
index_cp_reward_multiplier_one = lbAdd [2133, "1"];
index_cp_reward_multiplier_two = lbAdd [2133, "2"];
index_cp_reward_multiplier_five = lbAdd [2133, "5"];
lbSetCurSel [2133, index_cp_reward_multiplier_one];
