...
_helo = createVehicle ["B_Heli_Light_01_F", [_posplayer select 0, (_posplayer select 1)+2000, 200],[], 0, "FLY"];
...
// _helo lock false;
{doGetOut _x; sleep 1;} forEach assignedCargo _helo; //units group player; //assignedCargo
